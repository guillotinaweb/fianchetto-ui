...
@Component({
    selector: 'ngx-chessboard',
    template: `<div id="ngx-board" style="width:500px"></div>`,
})
export class NgxChessboardComponent implements OnInit {
    ...
    private _pieceTheme: any = 'assets/img/chesspieces/wikipedia/{piece}.png';
    ...
    private load() {
        this.board = ChessBoard('ngx-board', {
